...
| Phase | Sprints | Focus |
|---|---|---|
| 1 | 1.1-1.4 | Infrastructure & Adapters |
| 2 | 2.1-2.4 | Engine Core Logic |
| 3 | 3.1-3.4 | Strategy Migration & Integration |
| 4 | 4.1-4.4 | Runtime & Execution |
| 5 | 5.1-5.2 | Observatory & Dashboard |
| 6 | 6.1-6.2 | Quality Assurance |
| 7 | 7.1-7.2 | Deployment |
...
**Files created:**
```
tie_v4/__init__.py, __main__.py, config.py, config/engine.yaml, pyproject.toml, requirements.txt, Makefile, tests/test_config.py
```

**Tasks:**
| # | Task | Hours | Output | Verify |
|---|------|-------|--------|--------|
| 1 | Scaffolding/Design | 1.5 | - | `pass` |
| 2 | Logic Implementation | 1.5 | - | `pass` |
| 3 | Core Integration | 2.0 | - | `pass` |
| 4 | Unit Testing | 2.0 | - | `pytest` |
| 5 | Docs/Validation | 1.5 | - | `check` |
| 6 | Rollout/Cleanup | 1.5 | - | `ok` |

**Key Signatures:**
```python
# Interface logic defined in modules
```

**Acceptance Criteria:**
- [ ] pip install -e . succeeds, config prints, env vars resolve, zero hardcoded paths

**Tests:**
- tests/test_config.py — 5 config loading/validation tests
...
**Files created:**
```
adapters/__init__.py, base.py, models.py, mt5_mock.py, registry.py, tests/test_mock_broker.py, test_mock_market.py, test_registry.py
```

**Tasks:**
| # | Task | Hours | Output | Verify |
|---|------|-------|--------|--------|
| 1 | Scaffolding/Design | 2.1 | - | `pass` |
| 2 | Logic Implementation | 2.1 | - | `pass` |
| 3 | Core Integration | 2.8 | - | `pass` |
| 4 | Unit Testing | 2.8 | - | `pytest` |
| 5 | Docs/Validation | 2.1 | - | `check` |
| 6 | Rollout/Cleanup | 2.1 | - | `ok` |
...
**Acceptance Criteria:**
- [ ] Mock broker submit/get_positions works, mock market get_candles/get_price works, registry returns MT5MockBroker for 'mock'

**Tests:**
- test_mock_broker (submit, modify sl/tp, close, positions), test_mock_market (candles, price, spread), test_registry (auto-detect, explicit)
...
**Files created:**
```
adapters/mt5_gateway.py, tests/test_gateway_adapter.py, test_gateway_integration.py
```

**Tasks:**
| # | Task | Hours | Output | Verify |
|---|------|-------|--------|--------|
| 1 | Scaffolding/Design | 2.4 | - | `pass` |
| 2 | Logic Implementation | 2.4 | - | `pass` |
| 3 | Core Integration | 3.2 | - | `pass` |
| 4 | Unit Testing | 3.2 | - | `pytest` |
| 5 | Docs/Validation | 2.4 | - | `check` |
| 6 | Rollout/Cleanup | 2.4 | - | `ok` |
...
**Acceptance Criteria:**
- [ ] get_account() returns real data, modify_order sends sl/tp, timeout retry works, Cloudflare tunnel works

**Tests:**
- test_gateway_adapter (connection, auth), test_gateway_integration (live-like data flow)

**Rollback:**
1. `git checkout main`
2. `pip install .`

#### Sprint 1.4 — MT5 Native + Docker (Day 10-14)

**Dependencies:** 1.3

**Files created:**
```
adapters/mt5_native.py, Dockerfile, requirements-win.txt
```
...
**Acceptance Criteria:**
- [ ] Windows: native returns real data, Linux: graceful fallback, auto-detect works

**Tests:**
- test_native_adapter (OS detection, package import), test_docker_build (multi-stage build)
...
**Files created:**
```
core/features/__init__.py, engine.py, models.py, tests/test_feature_engine.py
```

**Tasks:**
| # | Task | Hours | Output | Verify |
|---|------|-------|--------|--------|
| 1 | Scaffolding/Design | 2.7 | - | `pass` |
| 2 | Logic Implementation | 2.7 | - | `pass` |
| 3 | Core Integration | 3.6 | - | `pass` |
| 4 | Unit Testing | 3.6 | - | `pytest` |
| 5 | Docs/Validation | 2.7 | - | `check` |
| 6 | Rollout/Cleanup | 2.7 | - | `ok` |
...
**Acceptance Criteria:**
- [ ] valid FeatureSnapshot returned, atr is dict, no current_price attr, pure Python

**Tests:**
- test_feature_engine (compute, data types, validation)
...
**Files created:**
```
core/regime/*, core/opportunity/*, tests/test_regime.py, test_opportunity.py
```
...
**Acceptance Criteria:**
- [ ] regime identifies TRENDING/RANGING, opportunity BLOCKED returns reason, crypto skip

**Tests:**
- test_regime (detection logic), test_opportunity (window score evaluation)
...
**Files created:**
```
core/context/*, core/rules/*, tests/test_risk_registry.py, test_dynamic_lot.py, test_context.py
```
...
**Acceptance Criteria:**
- [ ] RiskRegistry returns RiskDecision, ASIA not ASIAN, SELL TP above entry REJECT, entry<=0 APPROVE, lot tiers correct

**Tests:**
- test_risk_registry (rule chain), test_dynamic_lot (sizing logic)
...
**Files created:**
```
core/strategy/base.py, result.py, exit_orchestrator.py, manager.py, tests/test_exit_orchestrator.py, test_strategy_manager.py
```
...
**Acceptance Criteria:**
- [ ] BaseStrategy.analyze() sig, ExitOrchestrator takes explicit dir, StrategyManager.run_all() runs enabled

**Tests:**
- test_exit_orchestrator (direction control), test_strategy_manager (lifecycle)
...
**Files created:**
```
strategies/bystra/strategy.py, config.py, metadata.py, detectors/*.py, tests/test_bystra.py, test_detectors.py
```
...
**Acceptance Criteria:**
- [ ] analyze() returns StrategyResult, all 14 detectors importable, TIE_B_BUY comment

**Tests:**
- test_bystra (analyze integration), test_detectors (pivot detection)
...
**Files created:**
```
strategies/aggressive/strategy.py, config.py, momentum_engine.py, entry_score_engine.py, tests/test_aggressive.py
```
...
**Acceptance Criteria:**
- [ ] uses context.current_price, entry_zone never {0,0}, weights match tuned values

**Tests:**
- test_aggressive (entry scoring, context access)
...
**Files created:**
```
strategies/semi_hft/strategy.py, entry_score.py, fast_risk.py, tests/test_semi_hft.py
```
...
**Acceptance Criteria:**
- [ ] entry_score >= 60, lot(300)=0.01, THRESHOLD=60 consistent

**Tests:**
- test_semi_hft (score threshold, lot sizing)

**Rollback:**
1. `git checkout main`
2. `pip install .`

#### Sprint 3.4 — Strategy Integration (Day 38-42)

**Dependencies:** 3.1+3.2+3.3

**Files created:**
```
runtime/multi_strategy.py, tradeplan_adapter.py, tests/test_multi_strategy.py, test_strategy_integration.py
```
...
**Acceptance Criteria:**
- [ ] fuse merges BA_ setup, dedup 120s, direction guard, correct comments

**Tests:**
- test_multi_strategy (deduplication, fusion), test_integration (full lifecycle)
...
**Files created:**
```
runtime/engine.py, tests/test_engine.py
```

**Tasks:**
| # | Task | Hours | Output | Verify |
|---|------|-------|--------|--------|
| 1 | Scaffolding/Design | 3.0 | - | `pass` |
| 2 | Logic Implementation | 3.0 | - | `pass` |
| 3 | Core Integration | 4.0 | - | `pass` |
| 4 | Unit Testing | 4.0 | - | `pytest` |
| 5 | Docs/Validation | 3.0 | - | `check` |
| 6 | Rollout/Cleanup | 3.0 | - | `ok` |
...
**Acceptance Criteria:**
- [ ] dry_run runs one cycle, heartbeat written, halt flag works, no hardcoded lot

**Tests:**
- test_engine (loop execution, heartbeat, shutdown)
...
**Files created:**
```
runtime/trailing_manager.py, contract_executor.py, tests/test_trailing_manager.py
```
...
**Acceptance Criteria:**
- [ ] only ONE process modifies positions, modify always sends (sl, tp) pair, per-strategy trailing

**Tests:**
- test_trailing_manager (position modify, SL/TP pair)

**Rollback:**
1. `git checkout main`
2. `pip install .`

#### Sprint 4.3 — Position Monitor + Tracker (Day 49-51)

**Dependencies:** 4.2

**Files created:**
```
runtime/position_monitor.py, trade_tracker.py, governance/daily_governor.py, tests/test_position_monitor.py
```

**Tasks:**
| # | Task | Hours | Output | Verify |
|---|------|-------|--------|--------|
| 1 | Scaffolding/Design | 1.8 | - | `pass` |
| 2 | Logic Implementation | 1.8 | - | `pass` |
| 3 | Core Integration | 2.4 | - | `pass` |
| 4 | Unit Testing | 2.4 | - | `pytest` |
| 5 | Docs/Validation | 1.8 | - | `check` |
| 6 | Rollout/Cleanup | 1.8 | - | `ok` |
...
**Acceptance Criteria:**
- [ ] detects closed positions, governor hibernates on target, dual-write works

**Tests:**
- test_position_monitor (tracking, close detection)
...
**Files created:**
```
runtime/health_monitor.py, scripts/install.sh, tie-v4.service
```
...
**Acceptance Criteria:**
- [ ] make install works, systemctl start works, status shows uptime, PID clean

**Tests:**
- test_health_monitor (uptime, heartbeat), test_install (systemd unit install)
...
**Files created:**
```
observatory/gate_observatory.py, postmortem.py, tests/test_observatory.py
```
...
**Acceptance Criteria:**
- [ ] record() inserts to SQLite, query_recent filters by timestamp, schema auto-creates

**Tests:**
- test_observatory (db record, query filtering)
...
**Files created:**
```
dashboard/__init__.py, server.py, static/index.html, app.js
```
...
**Acceptance Criteria:**
- [ ] dashboard at localhost:3002, /api/dashboard returns equity, positions show strategy cols

**Tests:**
- test_dashboard_api (endpoint connectivity, data fetch)
...
**Acceptance Criteria:**
- [ ] pytest passes, pytest --cov=core/ >80%

**Tests:**
- all modules coverage, integration (mock→pipeline→decision)
...
**Acceptance Criteria:**
- [ ] dry-run no real trades, decision match production, memory <200MB RSS

**Tests:**
- memory profiling, decision consistency check
...
**Acceptance Criteria:**
- [ ] staging runs 48h no crash, all decisions logged

**Tests:**
- 48h soak test, log rotation check
...
**Files created:**
```
scripts/deploy_prod.sh, README.md, CHANGELOG.md
```
...
**Acceptance Criteria:**
- [ ] systemctl start works, first trade correct, dashboard live

**Tests:**
- deployment smoke test, live dashboard verification
